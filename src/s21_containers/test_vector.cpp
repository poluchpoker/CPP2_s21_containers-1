...
#include "./vector/s21_vector.h"  // Предполагается, что ваш класс вектора называется "your_vector_class"

using namespace s21;

s21::vector<int> vec0_{1, 2, 3, 4, 5, 6, 7, 8, 9};

TEST(VectorTest, CreateAndAddElement) {
  vector<int> vec;
  vec.push_back(10);
...
TEST(VectorTest, AddMultipleElements) {
  vector<int> vec;
  vec.push_back(10);
  vec.push_back(20);
  vec.push_back(30);
...
// Добавьте здесь дополнительные тесты для проверки других функций вашего класса
// вектора
