...
TEST(ListTest, Unique) {
  s21::list<int> list = {1, 2, 2, 3, 3, 3, 4, 4, 4, 4};
...
void test_list_sorting() {
  ...
  myList.sort();
  if (myList.empty()) {
    std::cout << "Test 1: Sorting an empty list - PASSED" << std::endl;
  } else {
    std::cout << "Test 1: Sorting an empty list - FAILED" << std::endl;
  }

  // Test sorting a list with one element
  myList.push_back(5);
  myList.sort();
  if (myList.size() == 1 && myList.front() == 5) {
    std::cout << "Test 2: Sorting a list with one element - PASSED"
              << std::endl;
  } else {
    std::cout << "Test 2: Sorting a list with one element - FAILED"
              << std::endl;
  }
  ...
  myList.push_back(4);
  myList.sort();
  if (myList.size() == 4 && myList.front() == 1 && myList.back() == 5) {
    std::cout << "Test 3: Sorting a list with multiple elements - PASSED"
              << std::endl;
  } else {
    std::cout << "Test 3: Sorting a list with multiple elements - FAILED"
              << std::endl;
  }
  ...
  myList.push_back(1);
  myList.sort();
  if (myList.size() == 5 && myList.front() == 1 && myList.back() == 5) {
    std::cout << "Test 4: Sorting a list with duplicate elements - PASSED"
              << std::endl;
  } else {
    std::cout << "Test 4: Sorting a list with duplicate elements - FAILED"
              << std::endl;
  }
}
...
TEST(List, Constructor_Copy) {
  s21::list<const int> our_list = {1, 2, 3};
  std::list<int> std_list = {1, 2, 3};
  s21::list<const int> our_copy(our_list);
...
TEST(List, Iterator_End_Last) {
  s21::list<int> our_list = {1, 2, 3};
  std::list<int> std_list = {1, 2, 3};
  s21::list<int>::iterator our_it = our_list.end();
  --our_it;
  std::list<int>::iterator std_it;
  std_it = std_list.end();
  --std_it;
